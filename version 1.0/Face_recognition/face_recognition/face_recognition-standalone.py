...
yolo_model = YOLO('/version 1.0/Face_recognition/face_detection/yolo/weights/yolo11n-face.pt').to(device)
# Initialize ArcFace recognition model
recognizer = iresnet_inference(
    model_name="r100",
    path='/version 1.0/Face_recognition/face_recognition/arcface/weights/glink360k_cosface_r100_fp16_0.1.pth',
    device=device,
)

# Load pre-saved face features
feature_path = '/version 1.0/Face_recognition/datasets/face_features/glink360k_featuresALL'
