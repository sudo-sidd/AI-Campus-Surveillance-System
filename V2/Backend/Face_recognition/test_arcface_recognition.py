...
import time
import numpy as np
from face_recognize_yolo import process_faces

def parse_arguments():
    parser = argparse.ArgumentParser(description="Test ArcFace recognition on images, videos, or webcam")
    ...
    parser.add_argument("--threshold", "-t", type=float, default=0.5, help="Recognition threshold (default: 0.5)")
